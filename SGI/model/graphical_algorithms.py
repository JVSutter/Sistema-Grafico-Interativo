...
class GraphicalAlgorithms:
    ...
    @classmethod
    def sutherland_hodgman_clipping(
        cls, points: list[tuple[float, float]]
    ) -> list[tuple[float, float]]:
        """
        Algoritmo de Sutherland-Hodgman para recorte de polígonos.
        @param points: Lista de pontos do polígono em coordenadas normalizadas.
        @return: Lista de listas de pontos, cada uma representando uma parte que foi recortada
        """
