...
class Window:
    ...
    def get_center(self) -> tuple[float, float]:
        ...
        return (self.window_bounds.x_min + self.window_bounds.x_max) / 2, (self.window_bounds.y_min + self.window_bounds.y_max) / 2
    
    def get_width_height(self) -> tuple[float, float]:
        """Retorna a largura e a altura da janela de visualização. (Wx, Wy)"""
        
        return self.window_bounds.x_max - self.window_bounds.x_min, self.window_bounds.y_max - self.window_bounds.y_min
